...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/haydn/intelFPGA/17.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/soc_system_hps_0_fpga_interfaces_f2h_boot_from_fpga.sv"  -work fpga_interfaces           -cdslib ./cds_libs/fpga_interfaces.cds.lib          
